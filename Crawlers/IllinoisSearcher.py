...
baseUrl = "https://www2.illinois.gov/idoc/Offender/Pages/InmateSearch.aspx"
...
def baseCrawler(last, first):
    ...
    browser.find_element_by_xpath("/html/body/table/tbody/tr/td/table[2]/tbody/tr/td[1]/table/tbody/tr/td/form/font/"
                                  "p[1]/font/input").send_keys(last)
    browser.find_element_by_xpath("/html/body/table/tbody/tr/td/table[2]/tbody/tr/td[1]/table/tbody/tr/td/form/table/"
                                  "tbody/tr/td/input[1]").click()
